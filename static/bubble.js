...
function render_bubbles(id, word_data, width, height) {
...
/*
	...
	d3.csv("/static/data/all_sherlock.csv", display);
    });
  */
	...
	*/
	...
	display(test_data);
	*/
//	return d3.csv("/static/data/top_sherlock.csv", display);
