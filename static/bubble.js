...
bubble_plot.prototype.Bubbles = function() {
    ...
    force = d3.layout.force().gravity(0).charge(0).size([self.width, self.height]).on("tick", tick);
	...
	return selection.each(function(rawData) {
	    ...
	    node.append("rect").attr("id", "bubble-background").attr("width", self.width).attr("height", self.height).on("click", clear);
